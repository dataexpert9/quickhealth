namespace DAL
{
    ...
    public partial class BasketContext : DbContext
    {
        public BasketContext()
            : base("name=BasketContextQA")
        {
            Database.SetInitializer(new MigrateDatabaseToLatestVersion<BasketContext, DAL.Migrations.Configuration>());
