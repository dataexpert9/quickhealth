...
namespace BusinessLogic.UserServices
{
    public interface IUserService
    {
        ...
        bool UpdateNotificationStatus(bool Status,string Email);
        ...
        User MarkUserAccountAsVerified(UserModel model);
        ...
        FamilyMember AddNewFamilyMember(EditUserProfileBindingModel model);
        ...
        //PharmacyRequest Dispatch(AppointmentDispatchBindingModel model);
