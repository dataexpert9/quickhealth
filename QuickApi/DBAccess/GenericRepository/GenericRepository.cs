...
namespace DBAccess.GenericRepository
{
    ...
    public class GenericRepository<TEntity> where TEntity : class
    {
        ...
        /// <summary>
        /// generic method to fetch all the records from db with dependent entities
        /// </summary>
        /// <returns></returns>
        public virtual IEnumerable<TEntity> GetAllWithIncludeList(params string[] include)
        {
            IQueryable<TEntity> query = DbSet;
        ...
        /// <summary>
        /// Total count of record matching specific criteria
        /// </summary>
        /// <param name="predicate">Criteria to match on</param>
        /// <returns>Single integer of total count</returns>
        public int CountWithCondition(Expression<Func<TEntity, bool>> predicate)
        {
            return DbSet.Count(predicate);
        }

        /// <summary>
        /// Total count of record without condition
        /// </summary>
        /// <param name="predicate">No Criteria</param>
        /// <returns>Single integer of total count</returns>
        public int CountAllWithoutCondition()
        {
            return DbSet.Count();
        }
