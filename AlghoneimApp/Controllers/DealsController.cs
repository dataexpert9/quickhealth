...
//        public IHttpActionResult GetOffersAndDeals(int? StoreId, string OfferName = "" )
//        {
//            try
//            {
...
//                {
//                    productsQuery += " and Offers.Store_Id = " + StoreId.Value;
//                    packageQuery += " and Offers.Store_Id = " + StoreId.Value;
//                }
