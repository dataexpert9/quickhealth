...
//                                order.StoreOrders.FirstOrDefault(x => x.Id == StoreOrderId).RemoveFromDelivererHistory = true;

//                                order.RemoveFromDelivererHistory = !(order.StoreOrders.Any(x => x.RemoveFromDelivererHistory == false));
//                            }
//                            else
//                            {
//                                var order = ctx.Orders.FirstOrDefault(x => x.Id == OrderId);
...
//where Orders.User_Id = " + UserId + @" and Orders.IsDeleted = 0 and Users.IsDeleted = 0 and Orders.RemoveFromUserHistory = 0 ";
//                    }
//                    else
//                    {
//                        orderQuery = @"
...
//where Orders.DeliveryMan_Id = " + UserId + @" and Orders.IsDeleted = 0 and Orders.RemoveFromDelivererHistory = 0";
//                    }

//                    if (IsCurrentOrder)
//                        orderQuery += " and Orders.Status <> " + (int)OrderStatuses.Completed;
//                    else
//                        orderQuery += " and Orders.Status = " + (int)OrderStatuses.Completed;

//                    orderQuery += " ORDER BY Orders.id desc OFFSET " + PageNo * PageSize + " ROWS FETCH NEXT " + PageSize + " ROWS ONLY; ";
