...
//        public async Task<IHttpActionResult> SendPushNotification(string Text)
//        {
//            try
//            {
//                using (BasketContext ctx = new BasketContext())
//                {
//                    Global.objPushNotifications.SendIOSPushNotification(ctx.UserDevices.Where(x1 => x1.Platform == false).ToList(), new AdminNotifications { Title = "Swagger", Text = Text });
//                    Global.objPushNotifications.SendAndroidPushNotification(ctx.UserDevices.Where(x1 => x1.Platform == true).ToList(), new AdminNotifications { Title = "Swagger", Text = Text });
